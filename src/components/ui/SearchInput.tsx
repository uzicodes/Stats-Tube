    ...
    <div className="w-full max-w-2xl mx-auto space-y-2">
      <form onSubmit={handleSubmit} className="relative flex items-center w-full">
        ...
        <Input
          ...
          className="h-14 pl-10 pr-24 text-xs md:text-base lg:text-lg bg-zinc-950 border-zinc-800 rounded-full shadow-sm focus-visible:ring-zinc-700 text-green-500"
          disabled={isLoading}
        />
        <Button 
          type="submit" 
